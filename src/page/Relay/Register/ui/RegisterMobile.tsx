...
import registerStyle from "../css/RegisterMobile.module.css";
...
export default function RegisterMobile() {
  ...
  return (
    <div className={registerStyle.container}>
      {!isStepAdd ? (
        <>
          <span className="trip-h2">릴레이 등록</span>
          <span className={`trip-body2 ${registerStyle.titleText}`}>
            새로운 여행 릴레이를 등록해보세요.
          </span>
        </>
      ) : (
        <>
          <span className="trip-h2">릴레이 스텝 등록</span>
          <span className={`trip-body2 ${registerStyle.titleText}`}>
            당신이 여행한 장소를 등록해주세요.
          </span>
        </>
