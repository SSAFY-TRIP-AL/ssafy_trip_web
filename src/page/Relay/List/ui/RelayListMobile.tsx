...
import "../../../../style.css";
import relayListStyle from "../css/RelayListMobile.module.css";
...
export default function RelayListMobile() {
  const {
    keyword,
    setKeyword,
    category,
  ...
  return (
    <div className={relayListStyle.container}>
      <div className={relayListStyle.title}>
        <span className="trip-h2">릴레이 목록</span>
