    ...
    <div className="container">
      ...
      <div className={myPageStyle.statsRow}>
        ...
        <div className={myPageStyle.statItem}>
          ...
          <span className="trip-body1">시작한 릴레이</span>
          <span className="trip-h1">{profile.createdCount}</span>
        </div>
        <div className={myPageStyle.statItem}>
          <Heart size={20} className={myPageStyle.statIcon} />
          <span className="trip-body1">좋아요한 릴레이</span>
          <span className="trip-h1">{profile.likedCount}</span>
        </div>
      </div>

      <div className={myPageStyle.mainGrid}>
        <div className={myPageStyle.listSection}>
